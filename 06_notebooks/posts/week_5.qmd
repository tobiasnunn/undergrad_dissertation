...
library(flextable)
library(here)
athc <- read_delim(here("../99_archive/host_evaluation/accession_to_host_class.tsv"))
...
library(flextable)
library(here)
athcko <- read_delim(here("../99_archive/host_evaluation/accession_to_class_KO.tsv"))
